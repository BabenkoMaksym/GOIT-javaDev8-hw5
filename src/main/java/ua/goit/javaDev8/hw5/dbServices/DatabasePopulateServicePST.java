...
public class DatabasePopulateServicePST {
    public static void main(String[] args) {
        ...
        dbServices.populateDBTableWorker(createWorkersList());
        dbServices.populateDBTableClient(List.of(
                "Petro Rocket",
                "Petro Bumper",
                "Valeriy Repin",
                "Olga Komarova",
        ...
        dbServices.populateDBTableProject(createProjectsList());
        dbServices.populateDBTableProjectWorker(createProjectWorkerList());
    ...
    private static List<List<Integer>> createProjectWorkerList() {
    ...
    private static List<Project> createProjectsList() {
